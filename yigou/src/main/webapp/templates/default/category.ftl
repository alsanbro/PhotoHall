...
<div class="row mg-b">
    <div class="col-xs-6">
        <h3 class="no-margin">相册管理</h3>
    </div>
    <div class="col-xs-6 text-right">
        <a class="fa fa-plus btn btn-white" href="${contextPath}/admin/category/detail.html"> 添加相册</a>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
            ...
            <div class="panel-heading">
                <form class="form-inline" role="form" method="get" action="${contextPath}/admin/category.html">
                    <div class="form-group">
                        <label for="categoryname">相册名: </label>
                        <input class="form-control" id="name" name="name" placeholder="相册名: 输入*模糊匹配" type="text" value="${request.getParameter("name")!}">
                    </div>
                    &nbsp;
                    <div class="form-group">
                        <label for="group_id">父相册: </label>
                        <select class="form-control" id="parent_id" name="parent_id" data-placeholder="父相册" style="width:120px">
                            <#if model.model??>
                ...
                <div class="table-responsive">
                    <table
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td nowrap="nowrap">
                                        ...
                                        <span class="action-normal">
                                            <#if (model.parent)??>
                                            <#else>
                                                <button class="fa fa-plus btn btn-white"> 添加子相册</button>
                                            </#if>
                            ...
                            <tr class="empty-row">
                                <td nowrap="nowrap">
                                    还没有相册呀，<a class="fa fa-plus btn btn-white" href="${contextPath}/admin/category/detail.html"> 添加</a> 一个
                                </td>
                                <td></td>
                                <td></td>
                            </tr>
