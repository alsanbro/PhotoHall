...
public class Category extends BaseModel{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4338046516482757395L;
	@FormParam("name")
    ...
    public Category(String name, String coverPhoto, Integer number) {
		super();
		this.name = name;
		this.coverPhoto = coverPhoto;
		this.number = number;
